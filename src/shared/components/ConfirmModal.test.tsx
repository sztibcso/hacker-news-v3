...
describe('ConfirmModal', () => {
  ...
  describe('rendering', () => {
    ...
    it('displays both action buttons', () => {
      ...
      expect(screen.getByRole('button', { name: /Hell yea/i })).toBeInTheDocument();
    });
  });
  ...
  describe('user interactions', () => {
    ...
    it('calls onConfirm when Hell yea! button is clicked', async () => {
      ...
      await user.click(screen.getByRole('button', { name: /Hell yea/i }));
  ...
  describe('body scroll prevention', () => {
    ...
    it('restores body scroll when modal is closed', () => {
      ...
      rerender(<ConfirmModal isOpen={false} onClose={mockOnClose} onConfirm={mockOnConfirm} />);
