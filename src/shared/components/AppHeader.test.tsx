...
describe('AppHeader', () => {
  it('renders the main title and description', () => {
    ...
    expect(screen.getByText(/Discover the latest in tech, programming, and innovation/i)).toBeInTheDocument();
  });
  ...
  it('applies active styling to current page', () => {
    ...
    expect(homeLink).toHaveClass('bg-gray-300', 'text-orange');
  });
  ...
  it('applies custom className', () => {
    const { container } = render(<AppHeader className="custom-header" />, { wrapper: RouterWrapper });
